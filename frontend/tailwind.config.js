  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        monte: { from: { opacity: 0, transform: 'translateY(10px)' }, to: { opacity: 1, transform: 'none' } },
      },
      animation: {
        'accordion-down': 'accordion-down 0.2s ease-out',
        'accordion-up': 'accordion-up 0.2s ease-out',
        tampon: 'tampon 0.55s cubic-bezier(.2,.9,.3,1.2) both',
        monte: 'monte 0.35s ease-out both',
      },
    },
  },
